...
{{< image src="/images/redis_source_code/01_01.jpg" caption="SDS 内存构造" title="SDS 内存构造" >}}
...
{{< image src="/images/redis_source_code/01_02.jpg" caption="内存对齐与内存不对齐的区别" title="内存对齐与内存不对齐的区别" >}}
...
{{< image src="/images/redis_source_code/01_03.jpg" caption="embstr 和 raw 在内存上的存储方式" title="embstr 和 raw 在内存上的存储方式" >}}
